...
motor leftMotorA = motor(PORT4, ratio18_1, false);//front
motor leftMotorB = motor(PORT11, ratio18_1, false);
motor_group LeftDriveSmart = motor_group(leftMotorA, leftMotorB);
motor rightMotorA = motor(PORT6, ratio18_1, true);//front
  ...
  while(true) {
    if(RemoteControlCodeEnabled) {
      ...
      if (Controller1.ButtonL1.pressing()) {
        Motor3.spin(reverse, 9.0, volt);
        Controller1LeftShoulderControlMotorsStopped = false;
      } else if (Controller1.ButtonL2.pressing()) {
        Motor3.spin(forward, 9.0, volt);
        Controller1LeftShoulderControlMotorsStopped = false;
      ...
      // check the ButtonR1/ButtonR2 status to control Motor10
      if (Controller1.ButtonR1.pressing()) {
        Motor10.spin(forward, 5.5, volt);
        Controller1RightShoulderControlMotorsStopped = false;
      } else if (Controller1.ButtonR2.pressing()) {
        Motor10.spin(reverse, 5.5, volt);
        Controller1RightShoulderControlMotorsStopped = false;
